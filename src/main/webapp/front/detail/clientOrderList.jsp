...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/front/detail/style/css/index.css"/>
    ...
    <span style="float: right;padding-right: 20px">
		<div style="position: relative;top: -15px;">
			...
			<span style="position: relative;top: -70px;">
				时间：${day}
				<a href="#"
                   style="border: 1px solid darkgrey;border-radius: 10px;padding: 6px 5px;background-color: darkgrey;font-size: 15px;margin-left: 100px;">退出登录</a>
			</span>
		</div>
	</span>
</div>
