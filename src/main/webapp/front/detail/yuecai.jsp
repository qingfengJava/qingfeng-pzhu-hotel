			...
			<ul>
					...
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img src="/front/detail/style/images/baizhuoxia.jpg" width="214px" height="145px" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">白灼虾</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;36.0</a>
						</dd>
					</dl>
				</li>
				...
				<li>
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img width="214px" height="145px" src="/front/detail/style/images/baiqieji.jpg" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">白切鸡</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;68.0</a>
						</dd>
					</dl>
				</li>
				...
				<li>
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img width="214px" height="145px" src="/front/detail/style/images/kaoruzhu.JPG" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">烤乳猪</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;68.0</a>
						</dd>
				...
				<li>
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img width="214px" height="145px" src="/front/detail/style/images/shaoe.jpg" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">烧鹅</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;68.0</a>
						</dd>
				...
				<li>
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img width="214px" height="145px" src="/front/detail/style/images/helandou.jpg" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">猪肉荷兰豆</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;68.0</a>
						</dd>
				...
				<li>
					<dl>
						<dt>
							<a href="caixiangxi.jsp">
								<img width="214px" height="145px" src="/front/detail/style/images/huangbuchaodan.jpg" />
							</a>
						</dt>
						<dd class="f1">
							<a href="/front/detail/caixiangxi.jsp">黄埔炒蛋</a>
						</dd>
						<dd class="f2">
							<a href="/front/detail/caixiangxi.jsp">&yen;68.0</a>
						</dd>
